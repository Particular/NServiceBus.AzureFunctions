...
public sealed class FunctionEndpointGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var combined = functionInfos.Collect().Combine(assemblyClassName);

        context.RegisterSourceOutput(combined, static (spc, data) => GenerateSource(spc, data.Left, data.Right));
    }
