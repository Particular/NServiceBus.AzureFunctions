...
public class MessageProcessorTests
{
    ...
    public async Task Should_update_poison_dead_lettered_message_with_auto_generated_message_id()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.IsTrue(updatedProperties.ContainsKey(PipelineInvokingMessageProcessor.ServiceBusMessageIdKey), "MessageId property should be updated");
            var messageId = updatedProperties[PipelineInvokingMessageProcessor.ServiceBusMessageIdKey].ToString();
    ...
    public async Task Should_update_application_dead_lettered_message_with_auto_generated_message_id()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.True(result.MessageActions.WasDeadLettered, "Message should be dead lettered");
            Assert.IsTrue(updatedProperties.ContainsKey(PipelineInvokingMessageProcessor.ServiceBusMessageIdKey), "MessageId property should be updated");
            Assert.AreEqual(updatedProperties[PipelineInvokingMessageProcessor.ServiceBusMessageIdKey], autoGeneratedMessageId, "MessageId should be the auto generated value");
        }
    }
