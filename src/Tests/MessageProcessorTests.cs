...
public class MessageProcessorTests
{
    ...
    public async Task Should_use_auto_generated_message_id_if_present()
    {
        ...
        var message = ServiceBusModelFactory.ServiceBusReceivedMessage(properties: new Dictionary<string, object> { { PipelineInvokingMessageProcessor.AutoGeneratedServiceBusMessageIdKey, autoGeneratedMessageId } });
        var result = await ProcessMessage(
            message: message,
            onMessage: (context, _) =>
            {
    ...
    public async Task Should_update_poison_dead_lettered_message_with_auto_generated_message_id()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.IsTrue(updatedProperties.ContainsKey(PipelineInvokingMessageProcessor.AutoGeneratedServiceBusMessageIdKey), "MessageId property should be updated");
            var messageId = updatedProperties[PipelineInvokingMessageProcessor.AutoGeneratedServiceBusMessageIdKey].ToString();
    ...
    public async Task Should_update_application_dead_lettered_message_with_auto_generated_message_id()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.True(result.MessageActions.WasDeadLettered, "Message should be dead lettered");
            Assert.IsTrue(updatedProperties.ContainsKey(PipelineInvokingMessageProcessor.AutoGeneratedServiceBusMessageIdKey), "MessageId property should be updated");
            Assert.AreEqual(updatedProperties[PipelineInvokingMessageProcessor.AutoGeneratedServiceBusMessageIdKey], autoGeneratedMessageId, "MessageId should be the auto generated value");
        }
    }
