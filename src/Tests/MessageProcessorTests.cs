...
public class MessageProcessorTests
{
    ...
    public async Task Should_complete_messages_with_sequence_number_derived_id_immediately_if_previous_processing_attempt_was_successful()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            Assert.IsFalse(secondProcessingResult.OnMessageWasCalled, "OnMessage should not be called on second delivery");
            Assert.IsTrue(secondProcessingResult.MessageActions.WasCompleted, "Message should be completed on second delivery");
        }
    }
